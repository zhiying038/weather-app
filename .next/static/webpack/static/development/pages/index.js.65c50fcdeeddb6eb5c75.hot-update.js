...
function (_React$Component) {
  ...
  function Index(props) {
    ...
    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__["default"])(Index).call(this, props)); // this.apikey = "b71deb2566d82e77a5e670d0d3771d2a";
      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function APIRequest$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              forecastUrl = "".concat(this.apiurl, "/forecast?q=").concat(cityName, "&units=metric&appid=").concat(process.env.REACT_APP_API_KEY);
              _context2.next = 3;
            ...
            case 3:
              weatherUrl = "".concat(this.apiurl, "/weather?q=").concat(cityName, "&units=metric&appid=").concat(process.env.REACT_APP_API_KEY);
...
//# sourceMappingURL=index.js.65c50fcdeeddb6eb5c75.hot-update.js.map